...
export function FAQClient() {
  ...
  const faqData = {
      ...
      },
      {
        ...
        answer:
          "Toimitusaika Suomeen on 3-5 arkipäivää. Saat seurantanumeron heti kun tilaus on lähetetty. Voit seurata pakettisi kulkua sähköpostitse saamasi linkin kautta. Julisteet pakataan huolellisesti suojaputkeen.",
      },
      {
        question: "Onko toimitus ilmainen?",
        answer:
          "Kyllä, tarjoamme ilmaisen toimituksen yli 40€ tilauksiin Suomeen. Alle 40€ tilauksissa toimituskulut ovat 4,90€.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Kaikki julisteemme tulostetaan laadukkaalle mattapintaiselle julistepaperille (200g/m²). Paperi on paksu ja kestävä, ja värit ovat eloisia ja pitkäikäisiä. Suosittelemme kehystämistä lasin taakse parhaan tuloksen saavuttamiseksi.",
      },
      {
        question: "Tulevatko julisteet kehyksissä?",
        answer:
          "Julisteet toimitetaan ilman kehyksiä. Näin voit valita itse kehykset, jotka sopivat parhaiten sisustukseesi. Julisteet sopivat standardikokoisiin kehyksiin (A4, A3, 50x70cm, 70x100cm).",
      },
      {
        question: "Miten hoidan julisteitani?",
        answer:
          "Suojaa julisteet suoralta auringonvalolta ja kosteudelta. Suosittelemme kehystämistä lasin taakse, joka suojaa julistetta pölystä ja vaurioilta. Älä taita tai rullaa julistetta liian tiukasti.",
      },
      {
    ...
    en: [
      ...
      },
      {
        ...
        answer:
          "Delivery time to Finland is 3-5 business days. You will receive a tracking number as soon as your order is shipped. You can track your package through the link sent to your email. Prints are carefully packed in a protective tube.",
      },
      {
        question: "Is shipping free?",
        answer:
          "Yes, we offer free shipping on orders over 40€ to Finland. Orders under 40€ have a shipping cost of 4.90€.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "All our prints are printed on high-quality matte poster paper (200g/m²). The paper is thick and durable, and the colors are vibrant and long-lasting. We recommend framing behind glass for the best result.",
      },
      {
        question: "Do the prints come framed?",
        answer:
          "Prints are delivered without frames. This way you can choose frames that best suit your interior. The prints fit standard frame sizes (A4, A3, 50x70cm, 70x100cm).",
      },
      {
        question: "How do I care for my prints?",
        answer:
          "Protect prints from direct sunlight and moisture. We recommend framing behind glass, which protects the print from dust and damage. Do not fold or roll the print too tightly.",
      },
      {
