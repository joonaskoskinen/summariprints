...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-muted/20 py-16 md:py-20 texture-diagonal texture-sparkle relative">
          ...
          <div id="yhteystiedot">
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+358401234567" className="hover:text-accent transition-colors">
                  +358 40 123 4567
                </a>
              </li>
